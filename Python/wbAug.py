...
def parse_args():
    ...
    p("--out_dir", default="../results", help="Output directory")
...
def main():
    ...
    if args.input_image_dir is not None and args.ground_truth_dir is not None: # if input and ground truth directories are provided, augment training/ground truth files
        ...
        wbColorAug.trainingGT_processing(args.input_image_dir, args.out_dir, args.ground_truth_dir, args.out_ground_truth_dir, args.out_number, args.write_original)
        ...
        wbColorAug.single_image_processing(args.input_image_filename, args.out_dir, args.out_number, args.write_original)
